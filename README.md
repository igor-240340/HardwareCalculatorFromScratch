...
The project page on [Hackaday](https://hackaday.io/project/197623-hardware-calculator-from-scratch).
...
## Appendix (other computer arithmetic related projects)
...
Random number generator implementation can be found [here](https://github.com/igor-240340/RandomNumberGenerator).
